...
// Land → Sprache (für Auto-Erkennung, wenn der Nutzer nichts gewählt hat).
...
export function LanguageProvider({ children }) {
  ...
  // Aus dem Provider-Land ableiten — aber NUR, wenn der Nutzer nicht schon
  // manuell eine Sprache gewählt hat (kein localStorage-Override).
  ...
  const t = useCallback((key, vars) => {
    ...
    if (s == null) s = key // Sichtbar machen, dass ein Key fehlt
...
// Hook. Funktioniert auch außerhalb des Providers (Fallback auf Deutsch),
// damit nichts crasht, falls eine Komponente mal ohne Provider rendert.
